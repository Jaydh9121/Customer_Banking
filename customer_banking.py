...
savings_interest = float(input("Enter the APR interest rate for the savings account (in percentage): "))
savings_maturity = int(input("Enter the length of months to determine the amount of interest: "))
...
cd_interest = float(input("Enter the APR interest rate for the CD account (in percentage): "))
